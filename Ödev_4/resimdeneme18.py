...
resim1=cv2.imread("siyahbeyaz.jpg")
resim2boyut=cv2.imread("siyahbeyaz2.jpg")

yukseklik, genislik, _ = resim1.shape
resim2= cv2.resize(resim2boyut, (genislik, yukseklik))
